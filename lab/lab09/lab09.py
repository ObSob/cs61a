...
def inc_subseqs(s):
    ...
    def subseq_helper(s, prev):
        if not s:
            ...
            a = subseq_helper(s[1:], prev)  # skip this char
            b = subseq_helper(s[1:], s[0])  # use this char
...
def make_to_string(front, mid, back, empty_repr):
    ...
    def printer(lnk):
        if lnk is Link.empty:
            ...
            return front + printer(lnk.first) + mid + printer(lnk.rest) + back
    return printer
